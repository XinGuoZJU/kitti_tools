...
std::string KittiConfig::data_directory = "../kitti";
std::string KittiConfig::raw_data_directory = "2011_09_26";
std::string KittiConfig::dataset_folder_template = "2011_09_26_drive_%|04|_sync";
